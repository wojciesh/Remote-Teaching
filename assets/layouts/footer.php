<?php if (isset($_SESSION['auth'])) { ?>
    ...
    <footer id="myFooter">
            ...
            <div class="row">
                ...
                <div class="col-sm-3 my-3">
                    <div class="social-networks">
                        <a href="https://github.com/wojciesh/Remote-Teaching" class="twitter" target="_blank">
        ...
        <div class="footer-copyright">
            <p>
                <a href="https://github.com/wojciesh/Remote-Teaching" target="_blank">Open Source</a> |
                <a href="https://github.com/wojciesh" target="_blank">&copy; Wojciech Warpechowski</a> |
                <a href="https://github.com/wojciesh/Remote-Teaching/blob/master/LICENSE" target="_blank">MIT License</a>
            </p>
        </div>
    </footer>
